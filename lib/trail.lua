...
function twoLeadTrail:rebuildSpriteTasks()
   ...
   for i = 1, self.duration-1, 1 do
      ...
      v[1]:uv(0,i/self.duration):normal(UP)
		v[2]:uv(1,i/self.duration):normal(UP)
		v[3]:uv(1,(i+1)/self.duration):normal(UP)
		v[4]:uv(0,(i+1)/self.duration):normal(UP)
   ...
   for i = 1, self.duration-1, 1 do
      ...
      local v = new:getVertices()
      v[2]:uv(0,i/self.duration):normal(UP)
		v[1]:uv(1,i/self.duration):normal(UP)
		v[4]:uv(1,(i+1)/self.duration):normal(UP)
		v[3]:uv(0,(i+1)/self.duration):normal(UP)
